...
class GenericConsumer:
    ...
    def __init__(self, topic):
        ...
        self.consumer = KafkaConsumer(bootstrap_servers=f'{server}:9092', auto_offset_reset='earliest', value_deserializer=lambda x: json.loads(x), enable_auto_commit=False, fetch_max_wait_ms=11000)
    ...
    def __get_messages(self):
        ...
        while True:
            ...
            partitions = self.consumer.poll(timeout_ms=11000, update_offsets=False)
