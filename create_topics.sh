...
/kafka/bin/kafka-topics.sh --create --topic sunHour --partitions 3 --replication-factor 1 --bootstrap-server kafka:

/kafka/bin/kafka-topics.sh --create --topic beachHourFiltered --partitions 3 --replication-factor 1 --bootstrap-server kafka:9092
/kafka/bin/kafka-topics.sh --create --topic beachDayOrdered --partitions 3 --replication-factor 1 --bootstrap-server kafka:9092