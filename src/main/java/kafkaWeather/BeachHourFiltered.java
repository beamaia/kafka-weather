...
class BeachHourFiltered{  
	public static void main(String[] args){    
		...
		props.put(StreamsConfig.APPLICATION_ID_CONFIG, "kafka-weather-beach-hour-filtered");
        ...
        .join(precTable, (tempValue, precValue) -> {
            ...
            resultNode.put("hora", joinPrecTempValue.get("hora"));
            return resultNode;
        });
        ...
        filteredStream.foreach((key, value) -> System.out.println("Event: " + value + " Key: " + key));
